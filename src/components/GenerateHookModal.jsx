...
const GenerateHookModal = ({ onClose }) => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center">
      ...
      {/* Modal Content */}
      <div className="relative z-50 bg-white max-w-2xl w-full mx-4 rounded-2xl p-8">
        <div className="space-y-2.5">
          <h3 className="text-2xl font-bold text-black text-center">
            Generate Hook
          </h3>
          <p className="text-cGray text-base text-center">
        ...
        <div className="flex items-center gap-2.5 mt-8  justify-end">
          <Button
            label="Cancel"
            theme="ghost"
            // isLoading={loading}
            type="button"
            className={"w-24 border border-cGray"}
            onClick={onClose}
          />
          <Button
            label="Generate Hook"
